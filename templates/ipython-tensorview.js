...
''')`
    ...
    terminal.insertAndRunCommand('weight_tensor.set_evaluator(evaluator)', true);
    terminal.addHandler('weight_tensor', this.id, this.receive_tensor.bind(this));
